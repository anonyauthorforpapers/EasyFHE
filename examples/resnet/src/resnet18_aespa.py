...
# pkl_path = "/data/YOUNAME/data/encode_20250611_234607.pkl"
...
DIRECT_LOAD = True
pre_encode_type = "middle"
pkl_path = "/data/YOUNAME/data//encode_20250729_222205.pkl"
...
def layer1_32K(input, cryptoContext):
    ...
    if cryptoContext.rescaleTech == "FIXEDMANUAL":
        input = drop_list(input, res1, cryptoContext) # drop_last_elements ADD BY XXX
    ...
    res1 = homo_rescale_list(res1, 1, cryptoContext) # RESCALE ADD BY XXX
    ...
    res2 = homo_rescale_list(res2, 1, cryptoContext) # RESCALE ADD BY XXX
    ...
    if cryptoContext.rescaleTech == "FIXEDMANUAL":
        res1 = drop_list(res1, res2, cryptoContext) # drop_last_elements ADD BY XXX
...
def layer2_32K(input, cryptoContext):
    ...
    res1sx0 = homo_rescale_list(res1sx0, 1, cryptoContext)  # RESCALE ADD BY XXX
    res1sx1 = homo_rescale_list(res1sx1, 1, cryptoContext)  # RESCALE ADD BY XXX
    ...
    # YOUNAME: below is the same as the original
...
def homo_Aespa_perfect_square(x, filename, cryptoContext):
    x = fhe.homo_rescale(x, x.noise_deg - 1, cryptoContext)  # RESCALE ADD BY XXX
