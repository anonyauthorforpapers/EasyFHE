...
This repository contains the code used for an anonymous paper submission. All personal information has been removed to maintain anonymity. If you are interested in our project, please open an issue and we will provide you with the full link, where the code is actively maintained.

## Code Overview

The primary modifications can be found in the following directories:

- `torch/fhe`
- `aten/src/ATen/native/fhe`
- `examples`

The project has been tested on Ubuntu 24.04.
...
3. **Build and install the package:**
   ```bash
   USE_CUDA=1 USE_ROCM=0 USE_DISTRIBUTED=0 USE_MKLDNN=0 BUILD_TEST=0 USE_FBGEMM=0 USE_FLASH_ATTENTION=0 USE_MEM_EFF_ATTENTION=0 USE_NNPACK=0 USE_QNNPACK=0 USE_XNNPACK=0 python3 setup.py develop --install-dir=~/torch/
   ```

## Running the Examples

Once the installation is complete, you can run the examples located in the `examples` directory.
