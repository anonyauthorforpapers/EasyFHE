...
package_name = os.getenv("TORCH_PACKAGE_NAME", "easyfhe")
...
def main():
    ...
    setup(
        ...
        url="https://github.com/anonyauthorforpapers/EasyFHE",
        download_url="https://github.com/anonyauthorforpapers/EasyFHE.git",
        author="anonyauthorforpapers",
